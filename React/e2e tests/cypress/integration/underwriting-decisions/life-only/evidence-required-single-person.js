...
import evidenceRequiredDecision from '../../../pages/decisions/single-person-evidence-required';
...
const setup = {
  ...
  decision: config.decision.EVIDENCE_REQUIRED
};
...
evidenceRequiredDecision(setup);
// applicationSummary();
