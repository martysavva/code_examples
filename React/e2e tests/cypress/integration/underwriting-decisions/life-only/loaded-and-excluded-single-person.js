...
import loadedAndexcludedDecision from '../../../pages/decisions/single-person-loaded-and-excluded';
...
const setup = {
  ...
  decision: config.decision.NON_STANDARD_LOADED_EXCLUDED
};
...
loadedAndexcludedDecision(setup);
// applicationSummary();
