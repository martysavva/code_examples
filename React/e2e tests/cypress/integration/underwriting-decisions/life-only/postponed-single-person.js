...
import postponedDecision from '../../../pages/decisions/single-person-postponed';
import selectedCondition from '../../../pages/12-selected-condition';
import selectedConditionPart2 from '../../../pages/12a-selected-condition-part-2';
import selectedConditionPart3 from '../../../pages/12b-selected-condition-part-3';
...
const setup = {
  ...
  decision: config.decision.POSTPONE
};
...
selectedConditionPart2(setup);
selectedConditionPart3(setup);
postponedDecision(setup);
// applicationSummary();
